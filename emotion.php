...
try
{
	...
	echo '<div style="position: absolute; left: '.($result[$i]["faceRectangle"]["left"]*550/$size[0]+15).'; top:'.($result[$i]["faceRectangle"]["top"]*400/$size[1]).'; width: '. ($result[$i]["faceRectangle"]["width"]*550/$size[0]).'; height: '.($result[$i]["faceRectangle"]["height"]*400/$size[1]).';border: 3px solid #73AD21;"></div>';
	}
	echo "</div>";
